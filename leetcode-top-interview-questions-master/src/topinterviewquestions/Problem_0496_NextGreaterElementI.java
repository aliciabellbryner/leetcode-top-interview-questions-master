...
public class Problem_0496_NextGreaterElementI {
    ...
    //思路就是单调栈，当遍历到的当前值大于stack中顶部元素时，把stack顶部元素弹出，同时把这个顶部元素作为key，此时遍历到的num作为value放到hashmap中去
    public int[] nextGreaterElement(int[] findNums, int[] nums) {
        Map<Integer, Integer> map = new HashMap<>(); // map key: x, value: next greater element of x
