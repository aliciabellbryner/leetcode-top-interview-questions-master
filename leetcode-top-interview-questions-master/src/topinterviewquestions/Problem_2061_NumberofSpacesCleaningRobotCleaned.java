...
public class Problem_2061_NumberofSpacesCleaningRobotCleaned {
    ...
    public int numberOfCleanRooms(int[][] room) {
        ...
        int result = 0, currRow = 0, currCol = 0, currDir = 1;
